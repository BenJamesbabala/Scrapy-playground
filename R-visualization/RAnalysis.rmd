...
geo_job <- dbGetQuery(conn,'SELECT geo_job.url,geo_job.lat,geo_job.lon,jobs.title,jobs.company,jobs.city,jobs.location  FROM geo_job,jobs WHERE geo_job.url==jobs.url')
```
